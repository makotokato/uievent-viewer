	...
	var extra_options = [
		["checkbox", "readonlyToggle", "Read only <input>", {
			...
			'checked': false,
                ...
                ["checkbox", "spellcheckToggle", "spellcheck", {
                        'onclick': "toggleSpellcheck()",
                        'checked': false,
                }],
                ["checkbox", "autocorrectToggle", "autocorrect", {
...
function toggleSpellcheck() {
	var cbReadonly = document.getElementById("spellcheckToggle");
	var input = document.getElementById("input");
	if (cbReadonly.checked) {
...
function toggleAutocorrect() {
	var cbReadonly = document.getElementById("autocorrectToggle");
	var input = document.getElementById("input");
	if (cbReadonly.checked) {
		input.setAttribute('autocorrect', true);
	} else {
